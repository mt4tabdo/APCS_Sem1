...
System.out.println("Welcome to Type Quest!");
  ...
  System.out.println("Given a sentence, type it as fast as possible");
		...
		System.out.println("1 - Play set");
 System.out.println("2 - Play random");
 System.out.println("3 - Quit);");
 
  String whatgame = sc.nextLine();
     if (whatgame.equals("1")){ 
 System.out.println("Please enter what number sentence you'd like to play:");
        ...
        String something1 = (getSentence(sentence));
         ...
         System.out.println("Errors : " + compareSentences(something1, type) + "/" + lettersInSentence(type) + " Letters");
         
         System.out.println(lettersInSentence(type)/endTimer() * 60 + " letters per minute");
         System.out.println(wordsInSentence(type)/endTimer() * 60 + " words per minute");
         System.out.println("---------------------------------------------------------");
         
         
     }
       else if (whatgame.equals("2")) {
       
       	 System.out.println("-----------------Your sentence is:-----------------");
        String something2 = getSentence();
         ...
         System.out.println("Nice job! Here is your result!");
         System.out.println("Time: " + endTimer());
         System.out.println("Errors : " + compareSentences(something2, type2) + "/" + lettersInSentence(type2) + " Letters");
         
         System.out.println(lettersInSentence(type2)/endTimer() * 60 + " letters per minute");
         System.out.println(wordsInSentence(type2)/endTimer() * 60 + " words per minute");
         System.out.println("---------------------------------------------------------");
